...
ALTER TABLE user_login ADD UNIQUE KEY uk_email_conf_token (email_conf_token);
...
/*update user table*/
ALTER TABLE user MODIFY firstActive BIGINT(20);
ALTER TABLE user MODIFY lastActive BIGINT(20);
