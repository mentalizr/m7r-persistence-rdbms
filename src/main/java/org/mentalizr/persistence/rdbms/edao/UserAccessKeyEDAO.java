...
public class UserAccessKeyEDAO {
    ...
    private static final String FIND_ALL_ID_STATEMENT = "SELECT user_id FROM user_access_key";
    ...
    public static List<String> findAllIds() throws DataSourceException {
        ...
        try {
            ...
            ConnectionManager.releaseConnection(connection, UserAccessKeyEDAO.class);
        }
    }
